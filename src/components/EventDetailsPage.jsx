  ...
  return (
    <div className="container">
      ...
      <div className="filter-bar">
        <Link to="/landing" className="filter-link">Back</Link>
      </div>

      {/* Main Content */}
      <div className="event-details-content" style={{ display: 'flex', gap: '20px', marginTop: '20px' }}>
        {/* Left Container */}
        <div className="details-box" style={{ flex: 1, padding: '20px', border: '1px solid #ddd', borderRadius: '8px' }}>
          <Card className="event-details-card">
            <Text className="event-details-title" style={{ fontWeight: 'bold', fontSize: '20px', marginBottom: '10px' }}>
              Event Details
            </Text>
            <table className="event-details-table" style={{ width: '100%' }}>
              <tbody>
                <tr>
